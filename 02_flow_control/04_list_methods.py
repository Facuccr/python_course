###
# 04 - Listas Metodos # Los metodos mas importantes para trabajar con listas
###
...
lista1.append('e') # Añadir un elemento al final
print(lista1)

lista1.insert(1,'$') # inserta un elementi en la 
...
lista1.remove('$') # eliminar la primero aparicion de la cadena de texto
print(lista1)
...
print('Ordenar lista creando una nueva copia')
numbers = [3, 10, 2, 8, 99, 101]
